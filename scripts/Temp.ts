...
//     let wiql: Wiql = {'query' : "SELECT [System.Id] FROM workitems Where [System.TeamProject] = '" + Project.name + "' And [System.IterationPath] = '" + valval + "'"};  //+ ItterationString + ")" };// AND [System.WorkItemType] IN (" + WorkItemsString + ")"};
//     // call query
